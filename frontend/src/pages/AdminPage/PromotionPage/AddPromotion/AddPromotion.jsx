...
function AddPromotion({ open, onClose, onSuccess }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setSnackbar({ open: true, message: 'Lỗi khi thêm!', severity: 'error' })
    } finally {
      setLoading(false)
    }
  }
      ...
      >
        ...
        <DialogActions sx={{ p: 3, borderTop: '1px solid #333' }}>
          ...
          <Button
            ...
            sx={{ backgroundColor: '#66FF99', color: 'black', textTransform: 'none', fontWeight: 'bold', px: 3, '&:hover': { backgroundColor: '#52d17c' } }}
          >
